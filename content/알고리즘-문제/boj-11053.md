...
> [!note]
> [[longest-increasing-subsequence|LIS(Longest Increasing Subsequence)]]를 [[dynamic-programming|동적 프로그래밍]]으로 해결하는 기본 문제입니다.
...
이 문제는 [[longest-increasing-subsequence|LIS]]를 구하는 기본 문제입니다.
