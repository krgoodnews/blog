---
title: "유려한 레이아웃을 만들어요"
date: 2020-03-01
tags: [iOS, Design, Layout]
---
...
- 앞으로 가로모드, 멀티태스킹, 슬라이드오버 등의 애플 앱을 앱답게 쓸 수 있는 기능을 많이 지원하고 싶어하기에 레거시를 더이상 쌓으면 안 됩니다.
    ...
    ![멀티태스킹에 대한 설명](/posts/images/fluid-layout-multitasking-desc.png)
    
    멀티태스킹에 대한 설명
    
    ![아이패드의 멀티태스킹과 슬라이드오버 동시 사용.](/posts/images/fluid-layout-multitasking-example.png)
...
- 예시 이미지
    ...
    ![](/posts/images/fluid-layout-safe-area-1.png)
    
    ![](/posts/images/fluid-layout-safe-area-2.png)
...
- 예시 이미지
    ...
    ![](/posts/images/fluid-layout-readable-1.png)
    
    ![](/posts/images/fluid-layout-readable-2.png)
...
- (첨부) 기기별 화면 조합표
    ...
    ![](/posts/images/fluid-layout-size-class-1.png)
    
    ![](/posts/images/fluid-layout-size-class-2.png)
