...
> [!note]
> [[set-session-tracking|Set을 이용한 세션별 고유 사용자 추적]] 기법을 활용하여 해결하는 문제입니다.
...
이 문제는 [[set-session-tracking|Set을 이용한 세션별 고유 사용자 추적]] 기법을 직접 적용할 수 있는 문제입니다.
...
[[set-session-tracking|Set을 이용한 세션별 고유 사용자 추적]] 알고리즘을 사용합니다:
